...
PRETRAIN_RUN_ID="case2_1-vit-dgnet-pretrain-${STAMP}"
LINEAR_RUN_ID="case2_1-vit-dgnet-linear-probe-${STAMP}"
...
CUDA_VISIBLE_DEVICES=0 python engine/dg_train.py \
  ...
  --run-name case2_1-vit-dgnet-pretrain \
  --seed 42 \
  "${COMMON_DATA_ARGS[@]}" \
  "${COMMON_MODEL_ARGS[@]}" \
  "${LOSS_ARGS[@]}" \
...
CUDA_VISIBLE_DEVICES=0 python engine/linear_probe_train.py \
  ...
  --run-name case2_1-vit-dgnet-linear-probe \
  --seed 42 \
  "${COMMON_DATA_ARGS[@]}" \
  "${COMMON_MODEL_ARGS[@]}" \
